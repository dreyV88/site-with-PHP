    ...
    <div class="footer">
      <div class="container">
        ...
        <div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
          <h3>CONTACT INFO</h3>
          <ul>
            <li><i class="fa fa-home fa-2x"></i> Grand Place 59161 Cagnoncles</li>
            <hr>
            <li><i class="fa fa-phone fa-2x"></i> +336 00 00 00 00</li>
            <hr>
            <li><i class="fa fa-envelope fa-2x"></i> emile.pinoy@orange.fr</li>
          </ul>
        </div>
