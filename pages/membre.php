    ...
    <article>
        <div class="col-md-3">
            <ul class="nav nav-pills nav-stacked" id="myTab" role="tablist">
                <li class="nav-item"><a class="nav-link active" id="home-tab" data-toggle="pill" href="#home" role="tab" aria-controls="home" aria-selected="true">Mon profil</a></li>
                ...
                <form method="post">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input id="editor" class="form-control" style="color:darkgray; height:auto;" name="contenu" id="content" rows="35"><?= $users->nom_prenom ?>
                        </div>
                        <div class="form-group col-sm-12">
                            <label for="content">Modifier mon login</label>
                            <input id="editor" class="form-control" style="color:darkgray; height:auto;" name="contenu" id="content" rows="35"><?= $users->login ?>
                        </div>
                        <div class="form-group col-sm-12">
                            <label for="content">Modifier mon login</label>
                            <input id="editor" class="form-control" style="color:darkgray; height:auto;" name="contenu" id="content" rows="35"><?= $users->login ?>
